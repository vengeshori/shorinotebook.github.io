            ...
            $('.content-3-pel').each(function() {
                ...
                $win.on('load scroll', function() {
                    ...
                    if ($('.test-case-1').css('top') == '2016px') {
                        ...
                        if (scroll + ($winH / 2) > position1) {
							var rightpositionpoint = ((current + 40)*100/1440)*(1000/$winH);
							if (rightpositionpoint < 50){
								$('.pel-nonemove-line img').css({
                                	right: rightpositionpoint + '%'
								});
							};
							if (rightpositionpoint > 20){
								intmain = -(rightpositionpoint - 20)*0.6;
								if (intmain < -18 ){
									intmain = -18;
								};
								rotate($('.pel-nonemove-line img'),intmain)
							}else{
								rotate($('.pel-nonemove-line img'),0)
							}
                            $('.pel-nonemove-line').css('opacity', '1');
                        } else {
                            $('.pel-nonemove-line').css('opacity', '0');
